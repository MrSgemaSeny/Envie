...
- **Landing Page Overhaul**: Completely rewrote the public LandingPage component and styles using `envie_site.html` as the source of truth. Installed GSAP and implemented a full preloader, a ThreeJS rotating wireframe globe in Hero, ScrollTrigger scroll-driven ThreeJS helix ladder section, hold-to-blast particle animations, intersection observer stats counters, and automatic router redirection upon blast completion. Added an elegant 'Войти' navigation trigger linking to the app workspace dashboard.
